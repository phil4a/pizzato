(() => {
    ...
    document.querySelector(".info-delivery__input");
    const nskCoords = [ 54.981798, 83.007095 ];
    const zoomLevel = 10;
    ymaps.ready(initMap);
    function initMap() {
        new ymaps.Map("map-delivery", {
            center: nskCoords,
            zoom: zoomLevel,
            controls: []
        });
        ...
        new ymaps.SuggestView("info-delivery__input");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
